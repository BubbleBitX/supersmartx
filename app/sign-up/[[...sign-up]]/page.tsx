  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: "24px", fontWeight: 800, color: "#f5f5f5", marginBottom: "8px" }}>Create Account</div>
        <div style={{ fontSize: "13px", color: "#555", marginBottom: "28px" }}>
          Create a free account to save your graphics
        </div>
        {/* <SignUp /> */}
        <div style={{
          ...
          then uncomment the SignUp component above
        </div>
        <Link href="/" style={{
